        ...
        <div class="row">
            <div class="col-12 home--bg" style="background-image: url('{{asset('assets/images/background/home.jpg')}}')">
                <div class="login-card" style="background-color: rgb(0 0 0 / 40%);">
                    <form class="theme-form login-form" method='post' action={{route('checkLogin')}}>
                        @csrf
                        @method('POST')

                        <h3 class='fw-bold form--subheading text-center pb-3 mb-4 rounded-1' style="letter-spacing: .9px; border-width: 4px;" dir='ltr'>نظام إدارة المصاعد</h4>

    ...
    <div class="card ">
        <div class="card-body invoice-head pt-0 pb-0"> 
            ...
            <div class="row p-3" style="border: 1px solid #b9b9b9;" >
                ...
                <div class="col-sm-2">
                    <span id="left-header">المرجع : {{$installation->reference}}</span>
                </div>
            ...
            <div class="row">
                    ...
                    <div class="col-sm 4 ">
                        <h4><span style="font-size: 18px">العميل: </span>  <br> 
                            {{$installation->customer->first_name . ' '. $installation->customer->last_name}}</h4>
                    </div>


                    <div class="col-sm 4 text-center">
                        <h4> <span style="font-size: 18px">المصعد: </span>  <br>
                             {{$installation->elevator->name }}</h4>
                    </div>

                    <div class="col-sm 4" style="text-align: left">
                        <h4> <span style="font-size: 18px">السعر: </span>  <br>
                             {{$installation->price }}  <small>ريال</small></h4>
                    </div>
